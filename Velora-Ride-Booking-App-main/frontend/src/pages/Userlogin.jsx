      ...
      <div className="w-full mt-3 max-w-md mx-auto">
        ...
        <form className="w-full" onSubmit={submitHandler}>
          ...
          <input
            ...
            placeholder:text-base focus:outline-none focus:ring-2 focus:ring-violet-500"
            value={email}
          ...
          <button
            ...
            transition-colors duration-300 text-white text-lg 
            font-bold w-full py-3 rounded-2xl"
          >
            Login
          </button>
        </form>
        ...
        <div className="text-center mt-5 space-y-6">
          ...
          <Link
            ...
            bg-violet-700 hover:bg-violet-900 transition-colors 
            duration-300 text-white text-lg font-bold 
